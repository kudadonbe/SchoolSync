...
export interface AttendanceCorrectionLog {
  ...
  correctionType: string // 'checkIn' | 'checkOut' | 'breakIn' | 'breakOut' | 'otIn' | 'otOut' | 'wrongWorkcode' // Type of correction being requested
  ...
  status: string // 'pending' | 'approved' | 'rejected' // Admin review status
